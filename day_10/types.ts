...
addEmp({ id: 10, name: "balu", role: Role.User });
addEmp({ id: "xyz", name: "yadav", role: Role.User });
addEmp({ id: 20, name: "megha", role: Role.Admin, priviledges: [Priviledge.Read, Priviledge.Write] });
getEmp(0);
getEmp(1);
getEmp(2);
